...
*/
	...
	function external_image_import_all_ajax() {
		...
		$results = ( $response ? '<strong>' . $post->post_title . '</strong> had ('. $response .') images successfully imported<br />' : '<strong>' . $post->post_title . ': </strong> No images imported - you might want to check whether they still exist!' );
